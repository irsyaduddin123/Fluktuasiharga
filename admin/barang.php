        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Tambah Barang</a>
            </div>
            <div class="box-body">
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.barid').val(response.id);
      $('#edit_nama').val(response.name);
      $('.barnama').html(response.name);
    }
  });
}
</script>
